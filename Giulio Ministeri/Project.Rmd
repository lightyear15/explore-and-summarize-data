...
library(grid)
library(gridExtra)
ggplot(dts, aes(x=as.factor(season))) + geom_histogram()
summary(as.factor(dts$season))
```
     
As already noticed, data are equally distributed among seasons.
```{r,echo=FALSE}
ggplot(dts, aes(x=as.factor(weather))) + geom_histogram()
...
```{r,echo=FALSE}
ggplot(dts, aes(x=as.factor(holiday))) + geom_histogram()
summary(as.factor(dts$holiday))
ggplot(dts, aes(x=as.factor(workingday))) + geom_histogram()
...
```{r,echo=FALSE}
ggplot(dts, aes(x=temp)) + geom_histogram(binwidth=1) + facet_wrap(~season)
ggplot(dts, aes(x=as.factor(weather))) + geom_histogram() + facet_wrap(~season)
...
```{r,echo=FALSE}
ggplot(dts, aes(x=temp, y=registered)) + geom_jitter(alpha=1/4, position=position_jitter(width = .5)) + scale_x_log10() 
ggplot(dts, aes(x=temp, y=casual)) + geom_jitter(alpha=1/4, position=position_jitter(width = .5)) + scale_x_log10()
```
...
```{r,echo=FALSE}  
ggplot(dts, aes(x=windspeed, y=registered)) + geom_jitter(alpha=1/2, position=position_jitter(width = 1))
ggplot(dts, aes(x=windspeed, y=casual)) + geom_jitter(alpha=1/2, position=position_jitter(width = 1))
```
...
ggplot(dts, aes(x=as.factor(hour), y=registered)) + geom_boxplot()
ggplot(dts, aes(x=as.factor(hour), y=casual)) + geom_boxplot()
```
...
```{r, echo=FALSE}
ggplot(dts, aes(x=as.factor(year), y=registered)) + geom_boxplot()
ggplot(dts, aes(x=as.factor(year), y=casual)) + geom_boxplot()
```
...
```{r,echo=FALSE}
ggplot(dts, aes(x=humidity, y=registered, color=as.factor(weather))) + geom_jitter(alpha=1/2,position=position_jitter(width = 3))

ggplot(dts, aes(x=humidity, y=casual, color=as.factor(weather))) + geom_jitter(alpha=1/2,position=position_jitter(width = 3))
```
...
```{r,echo=FALSE}
ggplot(dts, aes(x=hour, y=registered, color=as.factor(workingday))) + geom_jitter(alpha=1/4,position=position_jitter(width = 0.5))
#ggplot(dts, aes(x=hour, y=registered, color=as.factor(workingday))) + geom_line(stat="summary", fun.y=mean)
ggplot(dts, aes(x=hour, y=casual, color=as.factor(workingday))) + geom_jitter(alpha=1/4,position=position_jitter(width = 0.5))
